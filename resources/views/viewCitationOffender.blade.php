...
@extends('layouts.layout_sidebar_offender')
@section('head')
@push('javascript')
            ...
            <div class="panel panel-default">
                <div class="panel-heading">
                    <label for="enterCitation" class="col-form-label">Citation Number<input type="text" id="enterCitation"/></label>
                        <a style="padding:10px; margin:10px;" type="button" class="btn btn-primary" href="/viewSummaryOffender">View</a>
                </div>
                ...
                <div class="row">
                    ...
                    @section('table_rows')
                            ...
                            <td> <a style="padding:10px; margin:10px;" type="button" class="btn btn-primary" href="/viewSummaryOffender">View</a></td>
                        </tr>
                            <tr>
